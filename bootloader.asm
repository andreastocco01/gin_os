...
main:
    mov [diskNum], dl ; il numero del disco da cui sto facendo il booting viene salvato nel registro dl.
...
times 512 db '.' ; riempio il settore successivo a quello di booting di 'A'
