...
start:
    ...
    ; carico second stage bootloader in memoria

    mov al, 2                                   ; numero di settori da leggere dal disco
    mov bx, second_stage_position               ; indirizzo di destinazione in memoria
    ...
    mov dl, [disk_num]                          ; passo il numero del disco da cui sto leggendo al second stage bootloader
    jmp second_stage_position
